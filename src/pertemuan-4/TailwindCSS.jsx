export default function TailwindCSS() {
    return (
        <div>
            <h1 class="border m-4">Belajar Thailand CSS 4</h1>
            <button className="bg-blue-500 text-white board 
...
function Spacing(){
    return (
        <div className="bg-white shadow-lg p-6 m-4 rounded-lg">
            ...
            <p className="mt-2 text-gray-600">Ini adalah contoh 
                penggunaan padding dan margin di Tailwind.</p>
        </div>
    )
}
...
function Typography(){
    return (
        <div>
            <h1 className="text-3xl font-bold text-cyan-400">Tailwind Typography</h1>
...
function BackgroundColors(){
    return(
        <div className="bg-amber-700 text-white p-6 rounded-lg shadow-lg">
